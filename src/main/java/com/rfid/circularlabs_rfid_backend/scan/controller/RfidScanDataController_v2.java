...
@RequestMapping("/rfidv2")
@RestController
public class RfidScanDataController_v2 {

    private final RfidScanDataService_v2 scanDataServiceV2;
    ...
    public synchronized ResponseEntity<ResponseBody> sendOutData(@RequestBody RfidScanDataOutRequestDto sendOutDatas)
        ...
        return new ResponseEntity<>(new ResponseBody(StatusCode.OK, scanDataServiceV2.sendOutData(sendOutDatas)), HttpStatus.OK);
    }
    ...
    public synchronized ResponseEntity<ResponseBody> sendInData(@RequestBody RfidScanDataInRequestDto sendInDatas)
        ...
        return new ResponseEntity<>(new ResponseBody(StatusCode.OK, scanDataServiceV2.sendInData(sendInDatas)), HttpStatus.OK);
    }
    ...
    public synchronized ResponseEntity<ResponseBody> sendReturnData(@RequestBody RfidScanDataReturnRequestDto sendReturnDatas)
        ...
        return new ResponseEntity<>(new ResponseBody(StatusCode.OK, scanDataServiceV2.sendReturnData(sendReturnDatas)), HttpStatus.OK);
    }
    ...
    public synchronized ResponseEntity<ResponseBody> sendCleaningData(@RequestBody RfidScanDataCleanRequestDto sendCleanDatas) throws InterruptedException {
        ...
        return new ResponseEntity<>(new ResponseBody(StatusCode.OK, scanDataServiceV2.sendCleaningData(sendCleanDatas)), HttpStatus.OK);
    }
    ...
    public synchronized ResponseEntity<ResponseBody> sendDiscardData(@RequestBody RfidScanDataDiscardRequestDto senddiscardDatas) throws InterruptedException {
        ...
        return new ResponseEntity<>(new ResponseBody(StatusCode.OK, scanDataServiceV2.sendDiscardData(senddiscardDatas)), HttpStatus.OK);
    }
